...
const chargeCreditCard = (card_number, expiry_date, cvv, amount, userId) => { new Promise((resolve, reject) => {
    console.log(expiry_date);
    var cardCode = cvv; 
    function checkResponse(response){
        const cardFields = {};
    
        cardFields.user = userId;
        ...
        cartFields.totalAmount = amount;

        const card = new Card(cardFields);
        card.save();
    ...
    chargeCreditCard(checkResponse);
