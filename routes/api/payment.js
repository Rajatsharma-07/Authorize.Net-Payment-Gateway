...
var recurring = require('../../helper/recurring');

router.post('/', (req, res) => {

    // axios.post(`/recurring?card_number=${formData.cardNumber}&expiry_date=${formData.expiryDate}&cvv=${formData.cvv}&amount=${amount}&timeperiod=${timePeriod}&id=${id}&user=${user}&currPlan=${currPlan}&timeLimit=${timeLimit}&occurrences=${occurrences}&limit=${limit}&remainingBalance=${remainingBalance}`)
    ...
    var currPlan = req.query.currPlan;
    var timeLimit = req.query.timeLimit;
    var occurrences = req.query.occurrences;
    var limit = req.query.limit;
    var remainingBalance = req.query.remainingBalance;

    recurring(cardNumber, expiryDate, cvv, amount, timePeriod, planId, user, currPlan, timeLimit, occurrences, limit, remainingBalance);
    }  catch (err) {
    ...
    //     var remainingBalance = parseInt(req.query.remainingBalance);
    ...
    //         subsfield.limit = limit + remainingBalance;
    //     }else{
    //         subsfield.limit = limit;
    //     }
    //     subsfield.limitUsed = 0;
