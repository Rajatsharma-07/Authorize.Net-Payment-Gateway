...
router.post('/', (req, res) => {
    console.log(req.query.expiry_date);
    var cvv = req.query.cvv; 
    function checkResponse(response){
        const cardFields = {};
    
        cardFields.user = '6321ab2945d1b99518bcfef3';
        cardFields.cardNumber = req.query.card_number;
        cardFields.expiryDate = req.query.expiry_date;

        const cartFields = {};

        cartFields.user = '6321ab2945d1b99518bcfef3';
        cartFields.totalAmount = null;

    try {
        card = new Card(cardFields);
        card.save();
        var cart = new Cart(cartFields);
        cart.save();
